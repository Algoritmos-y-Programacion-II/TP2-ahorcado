...
CharDinamico:: CharDinamico(int tamanioOut) {
    ...
    cout << "\n--CONSTRUCTOR 1 AVISO-- El vector dinamico se almacena en: " << (int *)palabra;
}
...
CharDinamico:: CharDinamico(string palabraOut, int tamanioOut) {
    ...
    cout << "\n--CONSTRUCTOR 2 AVISO-- El vector dinamico se almacena en: " << (int *)palabra;
}
...
CharDinamico:: ~CharDinamico() {
    if (tamanio > 0)
        delete [] palabra;
    cout << "\n--DESTRUCTOR AVISO-- Se libero la memoria almacenada en: " << (int *)palabra;
}
// -------------------------------->
